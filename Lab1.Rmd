...
*For all questions, include the R commands/functions that you used to find your answer (show the R chunk). Answers without supporting code will not receive credit. Write full sentences to describe your findings.*

In this lab, you will explore the dataset `faithful`. It contains information about eruptions of the Old Faithful geyser in Yellowstone National Park. The first few observations are shown below.
...
The first goal is to determine how many rows and columns are in the dataset. Without looking at the data, have each group member guess how many rows there are.
